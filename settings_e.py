...
#    game_title = "Evan's Tomb"
    game_title = "Please type title here!"

    # instructions  = ["Instructions:",
    #                 "1. Computer shows  a sequence of symbols",
    #                 "2. Player clicks the symbols in the same order",
    #                 "3. Three successful tries opens the chamber!"]

    instructions  = ["Instructions:",
                    "1. Computer shows  a sequence of symbols",
                    "2. Player clicks the symbols in the same order",
                    "3. A successful attempt unlocks a secret!",
                    "4. Have Fun and don't give up! (Only if you want to.) :)"]

    # each skill level gets its own win text
    # easy=artifacts, medium=Eye of Horus, Hard=Hidden Tomb
    win_text = [["You found a hidden secret!","You uncovered an old mystery","You found your old toys"],
                ["You found $1,000,000 dollar treasure!", "You found nothing of value! LOL! ","Someone was here before you!"],
                ["You found somebody's house! Wait what?!", "You found a trap door and you fell in! Goodbye!", "This place smells like s***!"]]

    # win_text = ["You found a Ancient Artifact!",
    #             "You found the Eye of Horus!",
    #             "You found a Hidden Tomb!"]
    ...
    # animations
    #-----------------------------------------
    pharao_speed = 1                    # use 0-5, 0=still, 5=fast
    gameboard_zoomout_duration = 4      # use 1-10 where 1=fast, 10=slow
    tile_pulse_duration_per_level = [0.4,0.3,0.25]           # use 0.2-0.5 where 0.2=fast, 0.5=slow
